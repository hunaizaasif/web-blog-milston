...
export default function BlogCard({ post }: { post: Post }) {
  return (
    <section className="flex flex-col justify-between ml-2 h-[480px]  rounded bg-white dark:bg-dark/40 shadow-md shadow-gray-300 dark:shadow-black/80 group hover:scale-105 transition-transform ease-out duration-300">
      {/* Image Section*/}
      ...
      <div className="flex flex-col justify-between gapx-y-4  p-4">
        ...
        <Link
          href={`/blog/${post.slug}`}
          className="block px-4 py-1 text-center bg-cyan-400  rounded text-dark font-semibold mt-4"
        >
          Read More
        </Link>
